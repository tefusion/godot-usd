...
inline Variant::Type get_godot_type(const Vector3 &) { return Variant::VECTOR3; }
inline Variant::Type get_godot_type(const Transform3D &) { return Variant::TRANSFORM3D; }
inline Variant::Type get_godot_type(const Quaternion &) { return Variant::QUATERNION; }
inline Variant::Type get_godot_type(const double &) { return Variant::FLOAT; }
inline Variant::Type get_godot_type(const float &) { return Variant::FLOAT; }
inline Variant::Type get_godot_type(const int &) { return Variant::INT; }
inline Variant::Type get_godot_type(const bool &) { return Variant::BOOL; }
inline Variant::Type get_godot_type(const String &) { return Variant::STRING; }
inline Variant::Type get_godot_type(const Color &) { return Variant::COLOR; }
inline Variant::Type get_godot_type(const Basis &) { return Variant::BASIS; }
///////////////////////////////////////////
